...
export function EditorialRegister() {
  ...
  const [brandOrChannel, setBrandOrChannel] = useState("");
            ...
            <div className="relative z-10 w-full max-w-[420px] space-y-5">
              ...
              {success ? (
                ...
                <>
                  ...
                  <button
                    type="button"
                    className="w-full py-3 px-4 rounded-full bg-white hover:bg-[#FDF1EE] border border-[#2D3B42]/15 text-[#2D3B42] font-bold text-xs flex items-center justify-center gap-3 transition-all duration-300 shadow-md active:scale-[0.98]"
                  >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div className="space-y-1">
                      <label
                        htmlFor="register-extra"
                        className="block text-[11px] font-bold uppercase tracking-wider text-slate-600"
                      >
                        {accountType === "CREATOR" ? "Link/Tên Kênh TikTok / Instagram" : "Tên Thương hiệu / Công ty"}
                      </label>
                      <input
                        id="register-extra"
                        name="brandOrChannel"
                        type="text"
                        required
                        value={brandOrChannel}
                        onChange={(e) => setBrandOrChannel(e.target.value)}
                        placeholder={
                          accountType === "CREATOR"
                            ? "@my_channel_name"
                            : "Công ty TNHH RedSun"
