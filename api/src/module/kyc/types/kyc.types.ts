...
export type KycOpeningPlan =
  ...
  | { kind: 'create'; attemptNo: number; carryOverFromSubmissionId: string | null };
export type KycTransitionActor = ERole | typeof KYC_SYSTEM_ACTOR;
export type KycTransitionMap = Record<EKycStatus, Partial<Record<EKycStatus, readonly KycTransitionActor[]>>>;
