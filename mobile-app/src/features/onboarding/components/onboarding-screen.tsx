...
import { useCarousel } from '@/features/onboarding/hooks/use-carousel';
        ...
        <View style={styles.copy}>
          <View style={styles.tag}>
            <Text style={styles.tagText}>
              {t(`redsun.slides.${slide}.tag`)}
            </Text>
          </View>
          <Text style={styles.title}>{t(`redsun.slides.${slide}.title`)}</Text>
          <Text style={styles.description}>
            {t(`redsun.slides.${slide}.body`)}
          </Text>
        </View>
        <BrandButton
          title={t('redsun.start')}
          onPress={() => router.push('/register')}
        />
        <BrandButton
          title={t('redsun.login')}
          secondary
