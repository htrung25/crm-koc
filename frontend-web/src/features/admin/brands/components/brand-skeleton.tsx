    ...
    <section className="space-y-4 animate-pulse">
      ...
      <div className="glass rounded-[26px] p-4 sm:p-5">
        <div className="flex flex-wrap gap-3">
          ...
          <div className="h-10 w-40 rounded-xl bg-[#2D3B42]/10" />
      ...
      <div className="glass overflow-hidden rounded-[26px]">
        <div className="p-4 border-b border-[#2D3B42]/5">
          <div className="h-6 w-36 rounded bg-[#2D3B42]/10" />
        </div>
        <div className="p-4 space-y-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex gap-4 items-center">
              <div className="h-10 w-40 rounded-lg bg-[#2D3B42]/10" />
              <div className="h-10 flex-1 rounded-lg bg-[#2D3B42]/5" />
              <div className="h-10 w-28 rounded-lg bg-[#2D3B42]/5" />
