              ...
              {step === 'credentials' ? (
                <form onSubmit={submitCredentials} className="space-y-5">
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      className={`w-[18px] h-[18px] shrink-0 rounded-[6px] border flex items-center justify-center transition-colors peer-focus-visible:ring-4 peer-focus-visible:ring-[#EF4623]/30 ${
                        keepSignedIn
