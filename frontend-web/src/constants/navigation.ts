...
export const ADMIN_NAV_ITEMS: NavigationItem[] = [
  ...
  {
    labelKey: 'campaigns',
    href: APP_ROUTES.admin.campaigns,
    iconName: 'megaphone',
  },
  {
  ...
  {
    labelKey: 'tasks',
    href: APP_ROUTES.admin.tasks,
    iconName: 'clipboardList',
  },
  { labelKey: 'reports', href: APP_ROUTES.admin.reports, iconName: 'barChart' },
];

/* Nhóm "Cấu hình hệ thống": thiết ảnh hưởng toàn hệ thống. Tách khỏi điều hướng nghiệp vụ */
...
export const WORKSPACES: Record<UserRole, WorkspaceConfig> = {
  ...
  BRAND: {
    ...
    navigation: [
      ...
      {
        labelKey: 'brandCampaigns',
        href: APP_ROUTES.brand.campaigns,
        disabled: true,
      },
      { labelKey: 'findKocs', href: APP_ROUTES.brand.creators, disabled: true },
      {
        labelKey: 'contracts',
        href: APP_ROUTES.brand.contracts,
        disabled: true,
      },
      {
        labelKey: 'campaignReports',
        href: APP_ROUTES.brand.reports,
        disabled: true,
      },
    ],
  },
  CREATOR: {
    ...
    navigation: [
      ...
      {
        labelKey: 'findCampaigns',
        href: APP_ROUTES.creator.campaigns,
        disabled: true,
      },
      {
        labelKey: 'acceptedJobs',
        href: APP_ROUTES.creator.jobs,
        disabled: true,
      },
      {
